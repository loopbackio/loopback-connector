...
var jutil = require('loopback-model/lib/jutil');
var utils = require('loopback-model/lib/utils');
var ModelBaseClass = require('loopback-model/lib/model');
var DataAccessObject = require('loopback-model-persistence/lib/dao');
var defineScope = require('loopback-model-persistence/lib/scope').defineScope;
